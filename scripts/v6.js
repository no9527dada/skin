...
const b = defineMultiCrafter({//钻矿加工厂
...
b.outputsPower = false;
const c = defineMultiCrafter({//高级煤炭机
...
c.outputsPower = false;
const d = defineMultiCrafter({//植物捣碎
    name: 'zhiwudaosuiji',
...
d.outputsPower = false;
const e = defineMultiCrafter({//制沙机
    name: 'zhishaji',
    noParallelAffect: false,
    itemCapacity: 20,
    liquidCapacity: 15,
...
e.outputsPower = false;
const f = defineMultiCrafter({
    name: 'liuji',
...
require('XuanZeV7-GC');//另一种多合成写法，液体打包和解包
//----------------------------------------------------------
